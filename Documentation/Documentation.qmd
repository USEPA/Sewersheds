...
```
```{r classMap}
hex.hwy <- st_read(here("Documentation/Data/hex_examples.gpkg"), layer = "hex_hwy")
start <- st_read(here("Documentation/Data/hex_examples.gpkg"), layer = "start")
end <- st_read(here("Documentation/Data/hex_examples.gpkg"), layer = "end")
line <- st_read(here("Documentation/Data/hex_examples.gpkg"), layer = "line")
...
```{r navMap}
nav.smooth <- st_read(here("Documentation/Data/hex_examples.gpkg"), layer = "navSmooth")
